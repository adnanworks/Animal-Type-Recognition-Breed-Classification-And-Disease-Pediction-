                        ...
                        _buildMenuItem(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ViewPlacesPage(title: ''),
                              ),
                            );
                          },
                        ),
                        _buildMenuItem(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ViewBookingsPage(title: ''),
                              ),
                            );
                          },
                        ),
                        _buildMenuItem(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => SpeciesPredictionPage(title: ''),
                              ),
                            );
                          },
                        ),
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildDrawerItem(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => UserViewProfilePage(title: '')),
              );
            },
          ),
          ...
          _buildDrawerItem(
            ...
            title: 'Predict Dog Disease',
            color: Colors.teal,
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const PredictDogDiseasePage(title: '',),
                ),
              );
            },
          ),
          ...
          _buildDrawerItem(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => ChangepwdPage(title: '')),
              );
            },
          ),
          ...
          _buildDrawerItem(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => Send_complaintPage(title: '')),
              );
            },
          ),
